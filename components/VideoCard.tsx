                ...
                <div onMouseEnter={()=>SetIsHover(true)} onMouseLeave={()=>SetIsHover(false)} className='rounded-3xl'>
                    <Link href={`/detail/${post._id}`}>
                        <video 
                            ...
                            ref={videoRef}
                            loop 
                            className='lg:w-[600px] h-[300px] md:h-[400px] lg:h-[530px] w-3/4 rounded-2xl cursor-pointer bg-[conic-gradient(at_top,_var(--tw-gradient-stops))] from-gray-900 via-gray-100 to-gray-900'>
